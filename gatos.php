...
<head>
    <meta charset="utf-8">    
    <title>Instituto Fica Comigo │ Gatos</title>
<!-- SEO Insituto Fica Comigo Início -->
    <meta name="author" content="Instituto Fica Comigo">
    <meta name="description" content="Vida não se compra, se cuida com amor. Cada um tem uma história, um olhar cheio de esperança e um coração pronto para retribuir com lealdade infinita. Abra seu coração! Adote com responsabilidade e ajude a transformar vidas.">
...
<!-- OPEN GRAPH FACEBOOK --> 
    ...
    <meta property="og:description" content="Vida não se compra, se cuida com amor. Cada um tem uma história, um olhar cheio de esperança e um coração pronto para retribuir com lealdade infinita. Abra seu coração! Adote com responsabilidade e ajude a transformar vidas.">
    ...
    <meta property="og:image" content="https://institutoficacomigo.org.br/images/capa_gatos.jpg">
<!-- CSS FILES -->
...
<!-- Google tag (gtag.js) -->
<script async src="https://www.googletagmanager.com/gtag/js?id=G-31VDQ48078"></script>
<script>
  window.dataLayer = window.dataLayer || [];
  function gtag(){dataLayer.push(arguments);}
  gtag('js', new Date());

  gtag('config', 'G-31VDQ48078');
</script>
...
<nav class="navbar navbar-expand-lg bg-white shadow-lg">
    <div class="container">
        <a href="index.html" class="navbar-brand"><img src="images/logo_ifc.png" alt="Logo" width="120"></a>
            <button class="navbar-toggler" type="button" data-bs-toggle="collapse" data-bs-target="#navbarNav" aria-controls="navbarNav" aria-expanded="false" aria-label="Toggle navigation"><span class="navbar-toggler-icon"></span></button>

        <div class="collapse navbar-collapse" id="navbarNav">
            <ul class="navbar-nav ms-auto">
                <li class="nav-item">
                    <a class="nav-link" href="index.html">Instituto Fica Comigo</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link click-scroll" href="#section_2">Gatos para adoção</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="#section_5">Contato</a>
                </li>
                <li class="nav-item">
                    <a href="faca_uma_doacao.html" class="btn btn-primary custom-btn" target="_blank">Faça uma Doação</a>
                </li>
            </ul>
        <div>
    </div>
...
<section class="projects section-padding" id="section_2">
    <div class="container" style="margin-bottom: 50px; text-align: center;">
        <h2>Adote com Amor e Transforme Vidas</h2>
        <h4>Galeria de fotos dos gatos</h4>
        <p>Para adotar um dos nossos gatinhos, é necessário agendar uma visita para conhecer o nosso gatil pelo WhatsApp.</p>
        <a href="https://wa.me/5541997466529?text=Ol%C3%A1%2C%20gostaria%20de%20agendar%20uma%20visita." target="_blank" class="btn btn-primary custom-btn">Agendar visita pelo WhatsApp</a>
        <hr>
    </div>
    <div class="container">
        <div class="row">            
            <?php
                $dir = "images/adocao/gatos"; // Caminho da pasta onde as fotos estão armazenadas
                $files = scandir($dir); // Lê todos os arquivos da pasta

                    foreach ($files as $file) {
                    // Exibe apenas arquivos de imagem
                        if (in_array(pathinfo($file, PATHINFO_EXTENSION), ['jpg', 'jpeg', 'png', 'gif'])) {
                        // Remove a extensão do arquivo e coloca a primeira letra em maiúscula
                        $fileNameWithoutExt = ucfirst(pathinfo($file, PATHINFO_FILENAME));

                            echo "
                                <div class='col-lg-3 col-12 text-center'> 
                                    <img class='img-fluid projects-image' src='$dir/$file' alt='$file'><br>                                    
                                    <a href='https://wa.me/5541997466529?text=Ol%C3%A1%2C%20tenho%20interesse%20em%20uma%20visita%20para%20adoção%20de%20gato.' class='btn btn-primary custom-btn mt-2' target='_blank' style='margin-bottom: 10px;'>Quero conhecer!</a>
                                </div>";
                        }
                    }
            ?>          
        ...
        <div class="row">                    
            <div class="col-lg-6 col-12">
                <form class="custom-form contact-form" action="https://api.web3forms.com/submit" method="post" role="form">
                    <input type="hidden" name="access_key" value="7848cdde-1ad7-4282-b9a6-4f45b47026f0">
                    <input type="hidden" name="subject" value="Formulário de contato Site Instituto Fica Comigo">
                    <input type="hidden" name="redirect" value="https://institutoficacomigo.org.br/obrigado.html">
