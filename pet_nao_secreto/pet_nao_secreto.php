...
$sql = "SELECT id, nome, imagem_url FROM animais ORDER BY nome ASC";
...
<head>
    ...
    <title>Pet Não Secreto de Natal</title>    
<!-- SEO Insituto Fica Comigo Início -->
    <meta name="author" content="Instituto Fica Comigo">
    <meta name="description" content="Pet Não Secreto De Natal │ Neste Natal, o <b>pet não será secreto</b> e queremos que você conheça a história que trouxe o animal que vai receber o seu carinho até aqui.
...
<!-- OPEN GRAPH FACEBOOK --> 
    ...
    <meta property="og:description" content="Pet Não Secreto De Natal │ Neste Natal, o <b>pet não será secreto</b> e queremos que você conheça a história que trouxe o animal que vai receber o seu carinho até aqui.
    Que saiba de onde ele veio, o que enfrentou e o quanto sonha em sentir o amor de uma família.
    Cada história carrega marcas, mas também esperança. E é por isso que antes de escolher qual cão presentear (ou quem sabe adotar), convidamos você a ler todas as histórias, se emocionar e se conectar com seu escolhido.
    No final de cada história, deixamos a lista de presentes e seus valores... para que, com um simples Pix, você possa fazer a diferença mesmo na correria do dia a dia.
    Porque o Natal é sobre amor e este é o melhor presente que eles podem ganhar. ❤️">
    ...
    <div class="container">
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
            <ul class="navbar-nav ms-auto">
                ...
                <li class="nav-item">
                    <a class="nav-link click-scroll" href="#section_2">Pet Não Secreto de Natal</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="#section_5">Contato</a>
                </li>
                <li class="nav-item">
                    <a href="../faca_uma_doacao.html" class="btn btn-primary custom-btn">Faça uma Doação</a>
                </li>
            </ul>
        <div>
    </div>
...
<section class="projects section-padding" id="section_2">
    <div class="container" style="margin-bottom: 50px; text-align: center;">
        <h2>Pet Não Secreto De Natal</h2>
        <h4>Participe e ajude a transformar vidas</h4>
        <p style="text-align: left;">Neste Natal, o <b>pet não será secreto</b> e queremos que você conheça a história que trouxe o animal que vai receber o seu carinho até aqui.<br> 
        Que saiba de onde ele veio, o que enfrentou e o quanto sonha em sentir o amor de uma família.<br>
        Cada história carrega marcas, mas também esperança. E é por isso que antes de escolher qual cão presentear (ou quem sabe adotar), convidamos você a ler todas as histórias, se emocionar e se conectar com seu escolhido.<br>
        No final de cada história, deixamos a <b>lista de presentes e seus valores</b>... para que, com um simples Pix, você possa fazer a diferença mesmo na correria do dia a dia.<br>
        Porque o Natal é sobre amor e este é o melhor presente que eles podem ganhar. ❤️
        <hr>
    </div>
    <div class="container">        
        <div class="galeria-animais">
            <?php foreach ($animais as $animal): ?>
                <div class="animal-card">
                    <img src="<?php echo htmlspecialchars($animal['imagem_url']); ?>" alt="<?php echo htmlspecialchars($animal['nome']); ?>">
                    <div class="animal-info">
                        <h5><?php echo htmlspecialchars($animal['nome']); ?></h5>
                        <a href="minha_historia.php?id=<?php echo $animal['id']; ?>" class="btn btn-primary custom-btn mt-2">Ver Minha História</a>
                    </div>
                </div>
            <?php endforeach; ?>
        </div>
