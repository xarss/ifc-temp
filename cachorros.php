...
<head>
    <meta charset="utf-8">    
    <title>Instituto Fica Comigo │ Cachorros</title>
...
<!-- OPEN GRAPH FACEBOOK --> 
    ...
    <meta property="og:image" content="https://institutoficacomigo.org.br/images/capa_cachorros.jpg">
<!-- CSS FILES -->
    ...
    <div class="container">
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
            <ul class="navbar-nav ms-auto">
                ...
                <li class="nav-item">
                    <a class="nav-link click-scroll" href="#section_2">Cachorros para adoção</a>
                </li>
                <li class="nav-item">
...
<section class="projects section-padding" id="section_2">
    <div class="container" style="margin-bottom: 50px; text-align: center;">
        ...
        <h4>Galeria de fotos dos cachorros</h4>
        <hr>
    </div>
    <div class="container">
        <div class="row">            
            <?php
                $dir = "images/adocao/cachorros"; // Caminho da pasta onde as fotos estão armazenadas
                        ...
                        $fileNameWithoutExt = ucfirst(pathinfo($file, PATHINFO_FILENAME));
                            ...
                            echo "
                                <div class='col-lg-3 col-12 text-center'> 
                                    ...
                                    <div class='filename'><h5>" . htmlspecialchars($fileNameWithoutExt) . "</h5></div>
                                    <a href='https://wa.me/5541997466529?text=Ol%C3%A1%2C%20gostaria%20de%20adotar%20um%20cachorro.' class='btn btn-primary custom-btn mt-2' target='_blank' style='margin-bottom: 10px;'>Quero adotar</a>
                                </div>";
                        }
                    }
            ?>          
